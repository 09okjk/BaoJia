...
from skill import check_quote_feasibility, dump_json, load_json
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Check quote feasibility from quote_request input."
    )
    ...
    result = check_quote_feasibility(payload)
    if not args.skip_schema_validation:
