...
from skill import build_feedback_capture_result, dump_json, load_json
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Capture structured quote feedback.")
    ...
    result = build_feedback_capture_result(payload)
    if not args.skip_schema_validation:
