...
from skill import dump_json, load_json, review_rule_candidate
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Review feedback rule candidates.")
    ...
    result = review_rule_candidate(payload)
    if not args.skip_schema_validation:
