...
from skill import build_quote_document, dump_json, load_json
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build final quote_document output.")
    ...
    result = build_quote_document(payload)
    if not args.skip_schema_validation:
