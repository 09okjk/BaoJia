...
from skill import dump_json, load_json, select_quote_template
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Select quote template type from assessment report."
    )
    ...
    result = select_quote_template(payload)
    if not args.skip_schema_validation:
