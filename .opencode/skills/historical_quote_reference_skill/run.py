...
from skill import build_historical_reference, dump_json, load_json
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build historical quote reference from quote_request input."
    )
    ...
    result = build_historical_reference(payload)
    if not args.skip_schema_validation:
